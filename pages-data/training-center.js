...
const courses = [
  {
    ...
    signupHref: "#training-course-modal",
    programHref: "#",
...
const trainingCourseModal = {
  id: "training-course-modal",
  hasDynamicTitle: true,
  defaultCourseTitle: "Базовый курс по «АБАК ПЛК»",
  title: "Базовый<br>курс по<br>«АБАК ПЛК»",
  description: "Для записи на курс, пожалуйста, заполните форму.",
  background: "/images/contact-us/bg.webp",
  backgroundMobile: "/images/contact-us/bg-mobile.webp",
  formAction: "#",
  submitText: "Записаться",
  courseFieldName: "course",
  policyText:
    "Нажимая «Отправить», Вы даете свое согласие на обработку персональных данных и принимаете условия&nbsp;",
  policyLinkText: "политики конфиденциальности",
  policyLinkHref: "https://incomsystem.ru/upload/uf/baa/pol.pdf",
  closeAriaLabel: "Закрыть форму записи на курс",
  fields: [
    {
